class LocationStore {
  ...
  },
  {
    ...
    "city": "ANKARA",
    "district": "KEÇİÖREN",
    "address": "Köşk, Anavatan Cd. No:20, 06300 KEÇİÖREN/Ankara",
    "contract": true,
  ...
  },
  {
    ...
    "city": "AFYON",
    "district": "MERKEZ",
    "address": "HASAN KARAAĞAÇ MAHALLESİ TURGUT ÖZAL CADDESİ NO : 37 AFYON",
    "contract": true,
    "latitude": 38.7655258,
  ...
  },
  {
    ...
    "city": "BURSA",
    "district": "NİLÜFER",
    "address": "Odunluk Mahallesi, Liman Cd. No:4, 16110 NİLÜFER / BURSA",
    "contract": true,
    "latitude": 40.2097258,
    "longitude": 28.997232
  },
  ...
  },
  {
    ...
    "city": "ANKARA",
    "district": "SİNCAN",
    "address": "Andiçen Mah. Polatlı 2 Cad. İdil sok. No:44 SİNCAN / ANKARA",
    "contract": true,
    "latitude": 39.9566676,
    "longitude": 32.583186
  },
  ...
  },
  {
    ...
    "city": "BURSA",
    "district": "NİLÜFER",
    "address": "ahmet yasevi mah.piknik caddesi no:2 /7 NİLÜFER bursa",
    "contract": true,
    "latitude": 40.2685757,
  ...
  },
  {
    ...
    "city": "ANTALYA",
    "district": "SERİK",
    "address": "Orta Mah. Belek Cad. No.100/1 SERİK",
    "contract": true,
    "latitude": 36.9079242,
  ...
  },
  {
    ...
    "city": "ANTALYA",
    "district": "SERİK",
    "address": "Kadriye Beldesi, Akınlar Mah. Alan Cad. SERİK",
    "contract": true,
    "latitude": 36.8690619,
  ...
  // İleride eklenebilecek metodlar için:
  
  // Şehre göre lokasyonları getir
  getLocationsByCity(city) {
    return this.locations.filter(loc => loc.city === city);
  }

  // Türe göre lokasyonları getir
  getLocationsByType(type) {
    return this.locations.filter(loc => loc.type === type);
  }

  // Anlaşmalı lokasyonları getir
  getContractLocations() {
    return this.locations.filter(loc => loc.contract);
  }
}
